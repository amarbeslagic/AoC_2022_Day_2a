...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for(String st : listOfStrings){
            ...
            if(st.charAt(0) == 'A' && st.charAt(2) == 'X') sum += (1 + 3);
            else if(st.charAt(0) == 'A' && st.charAt(2) == 'Y') sum += (2 + 6);
            else if(st.charAt(0) == 'A' && st.charAt(2) == 'Z') sum += (3 + 0);
            ...
            else if(st.charAt(0) == 'C' && st.charAt(2) == 'X') sum += (1 + 6);
            else if(st.charAt(0) == 'C' && st.charAt(2) == 'Y') sum += (2 + 0);
            else if(st.charAt(0) == 'C' && st.charAt(2) == 'Z') sum += (3 + 3);
        }
